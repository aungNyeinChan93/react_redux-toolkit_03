...
const Navbar = () => {
    ...
    const changeTheme = () => {
        if (theme.color === 'dark') {
            setTheme(pre => ({ ...pre, color: 'white' }))
        } else {
            setTheme(pre => ({ ...pre, color: "dark" }))
        }
    };
                ...
                <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <span onClick={changeTheme} className='text-white text-lg capitalize px-4 py-2 rounded bg-gradient-to-r from-red-400 to-green-400'>{theme.color}</span>
                            </div>
